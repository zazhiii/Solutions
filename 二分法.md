...
public class Main {
    ...
    public static void solve(){
        ...
        if(sum <= p){pw.println(-1); return;}
        double l = 0, r = 1e10, eps = 1e-6;
        while(r - l > eps){
            double m = (l + r) / 2;
            if(check(m)) l = m;
            else r = m; 
...
public class Prac {
    ...
    public static void main(String[] args) throws IOException {
        ...
        pw.println(ans_1 == -1 ? -1 : (ans_1 + " " + ans_2));
        pw.flush();
    }   
    public static long check(long m){
        long cnt = 0, sum = 0;
        for(int i = 0; i < n; i ++){
