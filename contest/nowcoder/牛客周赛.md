...
>
> $f_1=\frac{a_1}{a_1+b_1}f_2+\frac{b_1}{a_1+b_1}f_1 + 1 \rightarrow f_1=f_2+\frac{a_1+b_1}{a_1}$
>
> $f_2=\frac{a_2^2}{(a_2+b_2)^2}f_3+\frac{2a_2b_2}{(a_2+b_2)^2}f_2+\frac{a_2^2}{(a_2+b_2)^2}f_3+1$ => $$
>
> 
